...
*   _.first(["a", "b", "c"], 2) -> ["a", "b"]
*/
//create a function called first that takes in an array and number as parameters 
...
_.reject = function (array, action) {
       let arr = [];
    _.filter(array,(element, index, array) => {
        if(!action(element, index, array)) {
            arr.push(element);
        }
...
_.pluck = function(array, key) {
    return _.map(array,function(object, i, a) {
        return object[key];
    })
}
...
*/
_.extend = function(object1, ...restOfObjects) {
